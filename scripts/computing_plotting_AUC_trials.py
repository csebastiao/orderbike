...
if __name__ == "__main__":
    ...
    sns.set_theme(font_scale=2.5, style="whitegrid")
    ...
    cm = 1 / 2.54
    fig, ax = plt.subplots(figsize=(47.08 * cm, 26.48 * cm))
    ...
    plt.savefig(str(folderoots) + "/plots/AUC_comparison_cov_dir_all_comm.png", dpi=500)
    plt.close()
