...
if __name__ == "__main__":
    folderoots = "./data/processed/ignored_files/utg_radio_concentric_trials"
    for folderoots in [
        "./data/processed/ignored_files/utg_diagonal_grid_trials",
        "./data/processed/ignored_files/utg_three bridges_trials",
    ]:
